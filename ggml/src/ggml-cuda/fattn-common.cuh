...
// =====================================================================================
// TCQ codebook arrays for flash attention (separate __constant__ copies for FA TU)
// =====================================================================================
// These mirror the codebooks in turbo-tcq.cuh but are in the fattn compilation unit.
// Constant memory serializes when threads hit different 32B cache lines;
// the VEC kernel copies these to shared memory for full 32-bank parallel access.

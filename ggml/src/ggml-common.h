...
// Storage block size = 128 (= WHT rotation group / head_dim granularity)
// Per block: norm(fp16, 2B) + 2-bit indices (32B) + 1-bit extra (16B) = 50 bytes per 128 values
...
#  define TURBO4_USE_4BIT 1  // Always use 4-bit PolarQuant (16 centroids, no QJL)
#endif
...
// Per block: norm(fp16, 2B) + 2-bit indices (32B) = 34 bytes per 128 values
